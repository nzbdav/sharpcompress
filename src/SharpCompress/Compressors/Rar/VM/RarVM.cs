...
internal sealed class RarVM : BitInput
{
    ...
    //    Mem.set_Renamed(offset + 1, Byte.valueOf((sbyte) ((value_Renamed >>> 8) & 0xff)));
    //    Mem.set_Renamed(offset + 2, Byte.valueOf((sbyte) ((value_Renamed >>> 16) & 0xff)));
    //    Mem.set_Renamed(offset + 3, Byte.valueOf((sbyte) ((value_Renamed >>> 24) & 0xff)));
